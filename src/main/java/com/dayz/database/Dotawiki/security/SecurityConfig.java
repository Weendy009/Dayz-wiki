...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/search/**", "/cars", "/medicaments", "/authorization", "/bookmarks/delete/**", "/bookmarks/getAll", "/bookmarks/add", "/api/weapons/filter", "/api/equipment/filter", "/adviсe_equipment", "/backpacks", "/equipment", "/weapons", "/change",
