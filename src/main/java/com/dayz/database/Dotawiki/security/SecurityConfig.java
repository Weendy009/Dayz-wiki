package com.dayz.database.Dotawiki.security;


import com.dayz.database.Dotawiki.entity.users.UserOauth;
import com.dayz.database.Dotawiki.repository.UserOauthRepository;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/illnesses", "/search/**", "/cars", "/medicaments", "/authorization", "/bookmarks/delete/**", "/bookmarks/getAll", "/bookmarks/add", "/api/weapons/filter", "/api/equipment/filter", "/adviсe_equipment", "/backpacks", "/equipment", "/weapons", "/change",
